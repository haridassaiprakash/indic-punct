...
from inverse_text_normalization.ne.data_loader_utils import get_abs_path
from inverse_text_normalization.ne.graph_utils import (
    NEMO_DIGIT,
    NEMO_SIGMA,
    NEMO_SPACE,
    GraphFst,
...
from inverse_text_normalization.ne.utils import num_to_word
...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        cents_data = pynini.accep("सौ") | pynini.accep("हंड्रेड") | pynini.accep("हन्ड्रड") | pynini.accep("हंडरेड") | pynini.accep("सय") | pynini.accep("सयौं") | pynini.accep("सयौँ")
        thousands_data = pynini.accep("थाउज़न्ड") | pynini.accep("हज़ार") | pynini.accep("थाउज़ेंड") | pynini.accep("हजार") | pynini.accep("थाउजेंड") | pynini.accep("थाउसेंड्स") | pynini.accep("हजारौं") | pynini.accep("हजारौँ") | pynini.accep("थाउजेन्ड्स")
        lakhs_data = pynini.accep("लाख") | pynini.accep("लैक") | pynini.accep("लेक") | pynini.accep("लाक") | pynini.accep("लक") | pynini.accep("लाखौँ")
        crores_data = pynini.accep("करोड़") | pynini.accep("क्रोर") | pynini.accep("क्रोर्स") | pynini.accep("करोड") | pynini.accep("कृत्त") | pynini.accep("कृत") | pynini.accep("करोडौं")


        del_And = pynutil.delete(pynini.closure(pynini.accep("एंड"), 1 ,1 ))
        
        hundred = pynini.cross("सौ", "100") | pynini.cross("हंड्रेड", "100") | pynini.cross("हन्ड्रड", "100") | pynini.cross("हंडरेड", "100") | pynini.cross("सय", "100") | pynini.cross("सयौं", "100") | pynini.cross("सयौँ", "100")
        thousand  = pynini.cross("हज़ार", "1000") | pynini.cross("थाउज़न्ड", "1000") | pynini.cross("थाउज़ेंड", "1000") | pynini.cross("थाउजेंड", "1000") | pynini.cross("हजार", "1000") | pynini.cross("थाउसेंड्स", "1000") | pynini.cross("हजारौं", "1000") | pynini.cross("हजारौँ", "1000") | pynini.cross("थाउजेन्ड्स", "1000")
        lakh = pynini.cross("लाख", "100000") | pynini.cross("लैक", "100000") | pynini.cross("लेक", "100000")  | pynini.cross("लाक", "100000")  | pynini.cross("लक", "100000")  | pynini.cross("लाखौँ", "100000")
        crore = pynini.cross("करोड़", "10000000") | pynini.cross("क्रोर", "10000000") | pynini.cross("क्रोर्स", "10000000") | pynini.cross("करोड", "10000000") | pynini.cross("कृत्त", "10000000") | pynini.cross("कृत", "10000000") | pynini.cross("करोडौं", "10000000")
        ...
        #else, just add 000
        thousands_prefix_digits =  (graph_digit | pynutil.insert("1")) + delete_space + pynutil.delete(thousands_data) + ( ((delete_space + del_And + delete_space | delete_space) + graph_hundred_component_at_least_one_none_zero_digit) |
        ...
        thousands_prefix_tens =  (graph_tens | graph_tens_en) + delete_space + pynutil.delete(thousands_data) + ( ((delete_space + del_And + delete_space | delete_space) + graph_hundred_component_at_least_one_none_zero_digit) |
                                                                                                       (pynutil.insert("0") + (delete_space + del_And + delete_space | delete_space) + (graph_tens | graph_tens_en)) |
                                                                                                       (pynutil.insert("00") + (delete_space + del_And + delete_space | delete_space) + graph_digit) |
                                                                                                        pynutil.insert("000", weight= -0.1) )

        thousands_prefix_hundreds =  (graph_hundred_component_at_least_one_none_zero_digit ) + delete_space + pynutil.delete(thousands_data) + ( ((delete_space + del_And + delete_space | delete_space) + graph_hundred_component_at_least_one_none_zero_digit) |
                                                                                                       (pynutil.insert("0") + (delete_space + del_And + delete_space | delete_space) + (graph_tens | graph_tens_en)) |
                                                                                                       (pynutil.insert("00") + (delete_space + del_And + delete_space | delete_space) + graph_digit) |
                                                                                                        pynutil.insert("000", weight= -0.1) )
        ...
        lakhs_prefix_tens =  (graph_tens | graph_tens_en) + delete_space + pynutil.delete(lakhs_data) + ( ((delete_space + del_And + delete_space | delete_space) + thousands_prefix_tens) |
                                                                                               (pynutil.insert("0")+ (delete_space + del_And + delete_space | delete_space) + thousands_prefix_digits) |
                                                                                               (pynutil.insert("0")+ (delete_space + del_And + delete_space | delete_space) + hundreds_prefix_tens) |
                                                                                               (pynutil.insert("00")+ (delete_space + del_And + delete_space | delete_space) + hundreds_prefix_digits) |
                                                                                               (pynutil.insert("000") + (delete_space + del_And + delete_space | delete_space) + (graph_tens | graph_tens_en )) |

...
from inverse_text_normalization.brx.data_loader_utils import get_abs_path
from inverse_text_normalization.brx.graph_utils import (
    NEMO_DIGIT,
    NEMO_SIGMA,
    NEMO_SPACE,
    GraphFst,
...
from inverse_text_normalization.brx.utils import num_to_word
...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        cents = pynini.accep("हंड्रेड") | pynini.accep("हन्ड्रेड") | pynini.accep("हन्ड्रड") | pynini.accep("नॉट") | pynini.accep("नोट") | pynini.accep("सेजौ") | pynini.accep("जौ")
        thousands = pynini.accep("थाउज़ेंड") | pynini.accep("थाउजेंड") | pynini.accep("थाउज़न्ड") | pynini.accep("थाउज़ेन्ड") | pynini.accep("थाउसेन्ड") | pynini.accep("रोजा")
        lakhs = pynini.accep("लाख") | pynini.accep("लैक") | pynini.accep("लेक")
        crores = pynini.accep("कौटि") | pynini.accep("क्रोर")

        del_And = pynutil.delete(pynini.closure(pynini.accep("एंड"), 1 ,1 ))
        
        graph_hundred = pynini.cross("हंड्रेड", "100") | pynini.cross("हन्ड्रेड", "100") | pynini.cross("हन्ड्रड", "100") | pynini.cross("नॉट", "100") | pynini.cross("नोट", "100") | pynini.cross("सेजौ", "100") | pynini.cross("जौ", "100")
        graph_thousand  = pynini.cross("थाउज़ेंड", "1000") | pynini.cross("थाउजेंड", "1000") | pynini.cross("थाउज़न्ड", "1000") | pynini.cross("थाउज़ेन्ड", "1000") | pynini.cross("थाउसेन्ड", "1000") | pynini.cross("रोजा", "1000")
        graph_lakh = pynini.cross("लाख", "100000") | pynini.cross("लैक", "100000") | pynini.cross("लेक", "100000")
        graph_crore = pynini.cross("कौटि", "10000000") | pynini.cross("क्रोर", "10000000")

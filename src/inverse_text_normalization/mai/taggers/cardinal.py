...
from inverse_text_normalization.mai.data_loader_utils import get_abs_path
from inverse_text_normalization.mai.graph_utils import (
    NEMO_DIGIT,
    NEMO_SIGMA,
    NEMO_SPACE,
    GraphFst,
...
from inverse_text_normalization.mai.utils import num_to_word
...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        cents_data = pynini.accep("सौ") | pynini.accep("हंड्रेड") | pynini.accep("हन्ड्रड") | pynini.accep("हंडरेड") | pynini.accep("सय") | pynini.accep("सैकड़ा")
        thousands_data = pynini.accep("थाउज़न्ड") | pynini.accep("हज़ार") | pynini.accep("थाउज़ेंड") | pynini.accep("हजार") | pynini.accep("थाउजेंड") | pynini.accep("थाउसेंड्स") | pynini.accep("हजारो")
        lakhs_data = pynini.accep("लाख") | pynini.accep("लैक") | pynini.accep("लेक") | pynini.accep("लाक")
        crores_data = pynini.accep("करोड़") | pynini.accep("क्रोर") | pynini.accep("क्रोर्स") | pynini.accep("करोड") | pynini.accep("करोड़क")


        del_And = pynutil.delete(pynini.closure(pynini.accep("एंड"), 1 ,1 ))
        
        hundred = pynini.cross("सौ", "100") | pynini.cross("हंड्रेड", "100") | pynini.cross("हन्ड्रड", "100") | pynini.cross("हंडरेड", "100") | pynini.cross("सय", "100") | pynini.cross("सैकड़ा", "100")
        thousand  = pynini.cross("हज़ार", "1000") | pynini.cross("थाउज़न्ड", "1000") | pynini.cross("थाउज़ेंड", "1000") | pynini.cross("थाउजेंड", "1000") | pynini.cross("हजार", "1000") | pynini.cross("थाउसेंड्स", "1000") | pynini.cross("हजारो", "1000")
        lakh = pynini.cross("लाख", "100000") | pynini.cross("लैक", "100000") | pynini.cross("लेक", "100000")  | pynini.cross("लाक", "100000")
        crore = pynini.cross("करोड़", "10000000") | pynini.cross("क्रोर", "10000000") | pynini.cross("क्रोर्स", "10000000") | pynini.cross("करोड", "10000000") | pynini.cross("करोड़क", "10000000")

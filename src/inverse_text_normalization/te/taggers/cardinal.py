...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        nuta_graph= ( pynutil.insert("1") + delete_hundreds + (delete_space + del_And + delete_space | delete_space) + ( pynutil.insert("0") + graph_digit | 
                                                                               graph_tens ))
        ...
        graph_lakhs = lakh | lakhs_prefix_digits | lakhs_prefix_tens

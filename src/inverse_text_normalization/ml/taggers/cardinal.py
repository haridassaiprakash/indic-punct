...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        thousands = pynini.accep("യിരം") | pynini.accep("യിരത്തി") | pynini.accep("തൗസൻഡ്")
        lakhs = pynini.accep("ലക്ഷം") | pynini.accep("ലക്ഷത്തി") | pynini.accep("ലാഖ്സ്") | pynini.accep("ലാഖ്") | pynini.accep("ലാഖ") | pynini.accep("ലാഖസ്")
        ...
        graph_thousand  = pynini.cross("യിരം", "1000") | pynini.cross("യിരത്തി", "1000") | pynini.cross("തൗസൻഡ്", "1000")
        graph_lakh = pynini.cross("ലക്ഷം", "100000") | pynini.cross("ലക്ഷത്തി", "100000") | pynini.cross("ലാഖ്സ്", "100000") | pynini.cross("ലാഖ്", "100000") | pynini.cross("ലാഖ", "100000") | pynini.cross("ലാഖസ്", "100000")

...
from inverse_text_normalization.sd.data_loader_utils import get_abs_path
from inverse_text_normalization.sd.graph_utils import (
    NEMO_DIGIT,
    NEMO_SIGMA,
    NEMO_SPACE,
    GraphFst,
...
from inverse_text_normalization.sd.utils import num_to_word
...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        cents_data = pynini.accep("سوھھ") |  pynini.accep("ھنڊريڊ") | pynini.accep("سئو") | pynini.accep("سؤ")
        thousands_data = pynini.accep("ہزارھ") | pynini.accep("ٿوسند") | pynini.accep("هزار") | pynini.accep("हजार") | pynini.accep("थाउजेंड") | pynini.accep("थाउजंड") | pynini.accep("थाउसंड")
        lakhs_data = pynini.accep("لکھ لک") | pynini.accep("لک")
        crores_data = pynini.accep("ڪرور") | pynini.accep("ڪروڙي")

        del_And = pynutil.delete(pynini.closure(pynini.accep("اند"), 1 ,1 ))
        
        hundred = pynini.cross("سوھھ", "100") | pynini.cross("ھنڊريڊ", "100") | pynini.cross("سئو", "100") | pynini.cross("سؤ", "100")
        thousand  = pynini.cross("ہزارھ", "1000") | pynini.cross("ٿوسند", "1000") | pynini.cross("هزار", "1000") | pynini.cross("थाउजेंड", "1000") | pynini.cross("हजार", "1000") | pynini.cross("थाउजंड", "1000") | pynini.accep("थाउसंड")
        lakh = pynini.cross("لکھ لک", "100000") | pynini.cross("لک", "100000")
        crore = pynini.cross("ڪرور", "10000000") | pynini.cross("ڪروڙي", "10000000")

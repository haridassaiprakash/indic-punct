...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        lakhs = pynini.accep("ಲಕ್ಷ") | pynini.accep("ಲಕ್ಷದ") | pynini.accep("ಲ್ಯಾಕ್ಸ್") | pynini.accep("ಲ್ಯಾಖ್") | pynini.accep("ಲ್ಯಾಕ್")
        ...
        graph_lakh = pynini.cross("ಲಕ್ಷ", "100000") | pynini.cross("ಲಕ್ಷದ", "100000") | pynini.cross("ಲ್ಯಾಕ್ಸ್", "100000") | pynini.cross("ಲ್ಯಾಖ್", "100000") | pynini.cross("ಲ್ಯಾಕ್", "100000")

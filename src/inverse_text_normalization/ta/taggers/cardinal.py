...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        cents = pynini.accep("ஹண்ட்ரட்‌") | pynini.accep("ஹண்ட்ரெட்‌") | pynini.accep("ஹன்ட்ரட்‌") | pynini.accep("ஹன்ட்ரெட்‌") | pynini.accep("ஹண்ட்ரட்")
        thousands = pynini.accep("தவுசண்ட்‌") | pynini.accep("தௌசண்ட்‌") | pynini.accep("தௌசண்ட்‌") | pynini.accep("தௌசண்ட்‌")
        lakhs = pynini.accep("லேக்‌") | pynini.accep("லாக்‌") | pynini.accep("லேக்") | pynini.accep("லேக்ஸ்")
        ...
        graph_hundred = pynini.cross("ஹண்ட்ரட்‌", "100") | pynini.cross("ஹண்ட்ரெட்‌", "100") | pynini.cross("ஹன்ட்ரட்‌", "100") | pynini.cross("ஹன்ட்ரெட்‌", "100") | pynini.cross("ஹண்ட்ரட்", "100")
        graph_thousand  = pynini.cross("தவுசண்ட்‌", "1000") | pynini.cross("தௌசண்ட்‌", "1000") | pynini.cross("தௌஸண்ட்", "1000") | pynini.cross("தௌசண்ட்", "1000")
        graph_lakh = pynini.cross("லேக்‌", "100000") | pynini.cross("லாக்‌", "100000") | pynini.cross("லேக்", "100000") | pynini.cross("லேக்ஸ்", "100000")
        graph_crore = pynini.cross("க்ரோர்‌", "10000000")
        

        #Handles 1-999 (direct spoken)
        #ஒரு தொள்ளாயிரத்தி ஐம்பது -->900        
        ...
        fst = pynini.union(fst_tam, tamil_graph_crores , tamil_graph_lakhs, tamil_graph_thousands, tamil_graph_exception_list,
                           fst_en, fst_crore, fst_lakh, graph_crore, graph_lakh, graph_thousand, graph_hundred, graph_multiples,graph_chars,graph_char_multiples, graph_tens_en)

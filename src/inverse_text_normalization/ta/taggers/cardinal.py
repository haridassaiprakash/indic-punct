...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        # In Tamil sometimes the hundreds are said as a combined word முந்நூறு "Munnoru"-->300 instead of மூன்று நூறு "moondru nooru"--> 3 100
        ...
        # combining all the tamil graphs

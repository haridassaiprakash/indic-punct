...
from inverse_text_normalization.sd_dev.data_loader_utils import get_abs_path
from inverse_text_normalization.sd_dev.graph_utils import (
    NEMO_DIGIT,
    NEMO_SIGMA,
    NEMO_SPACE,
    GraphFst,
...
from inverse_text_normalization.sd_dev.utils import num_to_word
...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        lakhs_data = pynini.accep("लाख") | pynini.accep("लैक") | pynini.accep("लेक") | pynini.accep("लाक") | pynini.accep("लकु")
        ...
        lakh = pynini.cross("लाख", "100000") | pynini.cross("लैक", "100000") | pynini.cross("लेक", "100000")  | pynini.cross("लाक", "100000")  | pynini.cross("लकु", "100000")

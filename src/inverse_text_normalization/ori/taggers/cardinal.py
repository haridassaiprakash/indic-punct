...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        lakhs = pynini.accep("ଲକ୍ଷ") | pynini.accep("ଲକ୍ଷେ") | pynini.accep("ଲାଖ୍‌") | pynini.accep("ଲ୍ୟାକ୍") | pynini.accep("ଲ୍ୟାକ୍ସ")
        ...
        graph_lakh = pynini.cross("ଲକ୍ଷ", "100000") | pynini.cross("ଲକ୍ଷେ", "100000") | pynini.cross("ଲାଖ୍‌", "100000") | pynini.cross("ଲ୍ୟାକ୍", "100000") | pynini.cross("ଲ୍ୟାକ୍ସ", "100000")

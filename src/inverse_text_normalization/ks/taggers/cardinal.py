...
from inverse_text_normalization.ks.data_loader_utils import get_abs_path
from inverse_text_normalization.ks.graph_utils import (
    NEMO_DIGIT,
    NEMO_SIGMA,
    NEMO_SPACE,
    GraphFst,
...
from inverse_text_normalization.ks.utils import num_to_word
...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        cents_data = pynini.accep("ہنڈریڈ") | pynini.accep("ہنڈریڈس") | pynini.accep("ہتھ۔")
        thousands_data = pynini.accep("ساس۔") | pynini.accep("تھوسنٛد") | pynini.accep("تھوٚسٕنٛدس")
        lakhs_data = pynini.accep("لکھ") | pynini.accep("لکھس")
        crores_data = pynini.accep("کروڑ") | pynini.accep("کروڑس")

        del_And = pynutil.delete(pynini.closure(pynini.accep("एंड"), 1 ,1 ))
        
        hundred = pynini.cross("ہنڈریڈ", "100") | pynini.cross("ہنڈریڈس", "100") | pynini.cross("ہتھ۔", "100")
        thousand  = pynini.cross("ساس۔", "1000") | pynini.cross("تھوسنٛد", "1000") | pynini.cross("تھوٚسٕنٛدس", "1000")
        lakh = pynini.cross("لکھ", "100000") | pynini.cross("لکھس", "100000")
        crore = pynini.cross("کروڑ", "10000000") | pynini.cross("کروڑس", "10000000")

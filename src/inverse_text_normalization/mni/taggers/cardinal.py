...
from inverse_text_normalization.mni.data_loader_utils import get_abs_path
from inverse_text_normalization.mni.graph_utils import (
    NEMO_DIGIT,
    NEMO_SIGMA,
    NEMO_SPACE,
    GraphFst,
...
from inverse_text_normalization.mni.utils import num_to_word
...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        cents_data = pynini.accep("ꯆꯥ ꯑꯃ") | pynini.accep("ꯑꯃ") | pynini.accep("ꯍꯟꯗ꯭ꯔꯦꯗ") | pynini.accep("ꯍꯟꯗ꯭ꯔꯦꯗꯁ") | pynini.accep("ꯑꯍꯨꯝ꯫")
        thousands_data = pynini.accep("ꯂꯤꯁꯤꯡ ꯑꯃ") | pynini.accep("ꯊꯧꯁꯥꯟꯗ") | pynini.accep("ꯊꯧꯁꯥꯟꯗꯁ") | pynini.accep("ꯂꯤꯁꯤꯡ")
        lakhs_data = pynini.accep("ꯂꯤꯆꯥ") | pynini.accep("ꯂꯥꯈ") | pynini.accep("ꯂꯥꯛꯁ")
        crores_data = pynini.accep("ꯀ꯭ꯔꯣꯔ") | pynini.accep("ꯀ꯭ꯔꯣꯔꯁ") | pynini.accep("ꯀ ꯭ꯔꯣꯔ")


        del_And = pynutil.delete(pynini.closure(pynini.accep("ꯑꯦꯟꯗ"), 1 ,1 ))
        
        hundred = pynini.cross("ꯆꯥ ꯑꯃ", "100") | pynini.cross("ꯑꯃ", "100") | pynini.cross("ꯍꯟꯗ꯭ꯔꯦꯗ", "100") | pynini.cross("ꯍꯟꯗ꯭ꯔꯦꯗꯁ", "100") | pynini.cross("ꯑꯍꯨꯝ꯫", "100")
        thousand  = pynini.cross("ꯂꯤꯁꯤꯡ ꯑꯃ", "1000") | pynini.cross("ꯊꯧꯁꯥꯟꯗ", "1000") | pynini.cross("ꯊꯧꯁꯥꯟꯗꯁ", "1000") | pynini.cross("ꯂꯤꯁꯤꯡ", "1000")
        lakh = pynini.cross("ꯂꯤꯆꯥ", "100000") | pynini.cross("ꯂꯥꯈ", "100000") | pynini.cross("ꯂꯥꯛꯁ", "100000")
        crore = pynini.cross("ꯀ꯭ꯔꯣꯔ", "10000000") | pynini.cross("ꯀ꯭ꯔꯣꯔꯁ", "10000000") | pynini.cross("ꯀ ꯭ꯔꯣꯔ", "10000000")

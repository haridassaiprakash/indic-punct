...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        fst = pynini.union(fst, fst_crore, fst_lakh, graph_crore, graph_lakh, graph_thousand, graph_hundred,graph_chars,graph_multiples,graph_tens_en)

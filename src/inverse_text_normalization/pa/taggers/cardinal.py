...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        lakhs = pynini.accep("ਲੱਖ") | pynini.accep("ਲਖ") | pynini.accep("ਲੈਕਸ") | pynini.accep("ਲੈਕ")
        ...
        graph_lakh = pynini.cross("ਲੱਖ", "100000") | pynini.cross("ਲਖ", "100000") | pynini.cross("ਲੈਕਸ", "100000") | pynini.cross("ਲੈਕ", "100000")

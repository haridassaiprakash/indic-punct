...
from inverse_text_normalization.ur.data_loader_utils import get_abs_path
from inverse_text_normalization.ur.graph_utils import (
    NEMO_DIGIT,
    NEMO_SIGMA,
    NEMO_SPACE,
    GraphFst,
...
from inverse_text_normalization.ur.utils import num_to_word
...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        cents = pynini.accep("سو") |  pynini.accep("ہنڈرڈ") | pynini.accep("سو .") 
        thousands = pynini.accep("ہزار") | pynini.accep("تھوسنڈ") | pynini.accep("ہزار۔")
        lakhs = pynini.accep("لکھنا") | pynini.accep("لکھ") | pynini.accep("لاکھ .")
        crores = pynini.accep("ملین") | pynini.accep("کروڑ")

        del_And = pynutil.delete(pynini.closure(pynini.accep("اند"), 1 ,1 ))
        
        graph_hundred = pynini.cross("سو", "100") | pynini.cross("ہنڈرڈ", "100") | pynini.cross("سو .", "100")
        graph_thousand  = pynini.cross("ہزار", "1000") | pynini.cross("تھوسنڈ", "1000") | pynini.cross("ہزار۔", "1000") 
        graph_lakh = pynini.cross("لکھنا", "100000") | pynini.cross("لکھ", "100000") | pynini.cross("لاکھ .", "100000") 
        graph_crore = pynini.cross("ملین", "10000000") | pynini.cross("کروڑ", "10000000")
